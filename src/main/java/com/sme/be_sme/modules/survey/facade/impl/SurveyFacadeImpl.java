...
public class SurveyFacadeImpl extends BaseOperationFacade implements SurveyFacade {
    ...
    private final SurveyAnalyticsReportProcessor surveyAnalyticsReportProcessor;
    ...
    private final SurveyInstanceGetProcessor surveyInstanceGetProcessor;
    private final SurveyResponseSaveDraftProcessor surveyResponseSaveDraftProcessor;
    private final SurveyTemplateDeleteProcessor surveyTemplateDeleteProcessor;
    private final SurveyAnalyticsAiSummaryProcessor surveyAnalyticsAiSummaryProcessor;
    private final SurveyManagerEvaluationTemplateCreateProcessor surveyManagerEvaluationTemplateCreateProcessor;
    private final SurveyManagerEvaluationTemplateUpdateProcessor surveyManagerEvaluationTemplateUpdateProcessor;
    @Override
    ...
    @Override
    public SurveyQuestionResponse updateSurveyQuestion(SurveyQuestionUpdateRequest request) {
        return call(surveyQuestionUpdateProcessor, request, SurveyQuestionResponse.class);
    }

    @Override
    public SurveyQuestionResponse deleteSurveyQuestion(SurveyQuestionDeleteRequest request) {
        return call(surveyQuestionDeleteProcessor, request, SurveyQuestionResponse.class);
    }
    ...
    @Override
    public SurveyAnalyticsReportResponse getSurveyAnalyticsReport(SurveyAnalyticsReportRequest request) {
        return call(surveyAnalyticsReportProcessor, request, SurveyAnalyticsReportResponse.class);
    }

    @Override
    public SurveyInstanceGetResponse getSurveyInstance(SurveyInstanceGetRequest request) {
        return call(surveyInstanceGetProcessor, request, SurveyInstanceGetResponse.class);
    }

    @Override
    public SurveyResponseSaveDraftResponse saveSurveyResponseDraft(SurveyResponseSaveDraftRequest request) {
        return call(surveyResponseSaveDraftProcessor, request, SurveyResponseSaveDraftResponse.class);
    }

    @Override
    public SurveyTemplateDeleteResponse deleteSurveyTemplate(SurveyTemplateDeleteRequest request) {
        return call(surveyTemplateDeleteProcessor, request, SurveyTemplateDeleteResponse.class);
    }

    @Override
    public SurveyAiSummaryResponse getSurveyAiSummary(SurveyAiSummaryRequest request) {
        return call(surveyAnalyticsAiSummaryProcessor, request, SurveyAiSummaryResponse.class);
    }
    @Override
    public SurveyTemplateResponse createManagerEvaluationTemplate( SurveyManagerEvaluationTemplateCreateRequest request) {
        return call( surveyManagerEvaluationTemplateCreateProcessor, request, SurveyTemplateResponse.class);
    }

    @Override
    public SurveyTemplateResponse updateManagerEvaluationTemplate(SurveyManagerEvaluationTemplateUpdateRequest request) {
        return call(surveyManagerEvaluationTemplateUpdateProcessor, request, SurveyTemplateResponse.class );
    }
}
